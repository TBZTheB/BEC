...
import cfg.nodes.IfConditionCfgNode;
import mark.Method;
...
public class CoverC2 extends Cover {
    ...
    public CoverC2(List<String> pathMarks, String filePath, Method method) {
    ...
    public String getCover() {
        ...
        for (String mark : marks) {
            ...
            if (findIsCondition(mark) != null && findIsCondition(mark).equals("false")) {
                ...
                node.setContent(findStatement(mark));
        ...
        for (Node nodeCondition : nodeConditions) {
            System.out.println(nodeCondition.getContent());
